...
description: Implement or modify Python backend features in this repository following the project's engineering rules. Use when adding endpoints, modifying services, creating DTOs, updating SQLAlchemy models, writing tests, or refactoring backend code in the api project.
---
